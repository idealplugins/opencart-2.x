...
class ControllerPaymentcreditcard extends Controller {
	...
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/creditcard.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/creditcard.tpl';
			} else {
			$this->template = 'default/template/payment/creditcard.tpl';
			}
    ...
    */
    ...
    public function storeTxid ($method, $txid, $order_id) {
    	...
    	$sql = "INSERT IGNORE INTO `".DB_PREFIX."creditcard` SET ".
    ...
    */
    ...
    public function getTxid ($order_id) {
    	...
    	$sql = "SELECT * FROM `".DB_PREFIX."creditcard` WHERE `order_id`='".$this->db->escape($order_id)."'";
	...
	*/
	...
	public function callback() {
		...
		$order_status_id = $this->config->get('creditcard_order_status_id');
        if (!$order_status_id) {
